...
# export CFLAGS="-O3 -DANDROID -ffast-math -fomit-frame-pointer -nostdlib -lc -lm  -L $NDKHOME/platforms/android-9/arch-arm/usr/lib/   -I $NDKHOME/platforms/android-9/arch-arm/usr/include/ -mfloat-abi=softfp -mandroid  -march=armv7-a  -mfpu=neon -mtune=cortex-a8 -funroll-loops -Isdl -ldl"
